...
import { getEventLikeUpdate,getLikedEvents, getEventInterestUpdate, getEventsData } from '../slices/event.slice';
...
export default LikedEventScreen = ({ props, setHeaderShown }) => {
    ...
    return (
        <>
            <Stack.Navigator initialRouteName="Liked Events"
                screenOptions={{
                    headerShown: true,
